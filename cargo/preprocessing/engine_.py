...
class NumericalDataEngine(BaseHelpers):
    ...
    def __init__(self, fill_na_with=None, mark_missing=False, scaling=False, **kwargs):
...
class InputProcessingEngine(BaseHelpers):
    ...
    def __init__(self, numerical_params, categorical_params, cat_fillna_with, num_fillna_with, **kwargs):
        super(InputProcessingEngine, self).__init__(**kwargs)
        self.X_cat = None
        self.X_cnt = None
        self.categoricalDataEngine = CategoricalDataEngine(**numerical_params, log=self.log)
        self.numericalDataEngine = NumericalDataEngine(**categorical_params, log=self.log)
        self.df = None
        self.df_processed = None
